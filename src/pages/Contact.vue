<template>
  ...
  <div class="contact container">
    ...
    <div class="form-sec" >
      <form action="" class="contact-form" @submit.prevent="sendingData" ref="form">
        <div class="uniq">
          <input type="text" placeholder="your name" ref="nameInput" required/>
          <input type="email" placeholder="your email" ref="mailInput" required/>
        </div>

        <input type="text" placeholder="your subject" ref="subjectInput" required/>
        <textarea placeholder="your message" ref="messageInput" required></textarea>
             <Button  type="submit">
        <template #content>
          <a>
            send message
  ...
  <message :theDialog="dialog" @changeDialog="changeDialog"/>
</template>
...
import { colRef } from "src/boot/firebase";
  ...
  setup() {
    ...
    const sendingData = () => {
      addDoc(colRef , {
        ...
        mail:mailInput.value.value,
        subject:subjectInput.value.value,
